          ...
          <div className="max-w-6xl mx-auto px-6 mt-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <p className="leading-relaxed">
                        We will be with you at every step, ensuring accuracy and
                        consistency throughout your application process. Our
                        team keeps you informed and updated on your application
                        status, providing peace of mind during this important
                        journey.
                      </p>
                      ...
                      <div className="space-y-3">
                        ...
                        <ul className="space-y-2">
                          <li className="flex items-start space-x-2">
                            ...
                            <span>
                              Personalized immigration strategies tailored to
                          ...
                          <li className="flex items-start space-x-2">
                            <div className="w-2 h-2 bg-white rounded-full mt-2"></div>
                            <span>
                              Expert guidance from licensed immigration
                              consultants
                            </span>
                          </li>
                          <li className="flex items-start space-x-2">
            ...
            <div className="bg-[#1a2b4b] text-white p-8 rounded-lg mt-12">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="leading-relaxed">
                  We will be with you at every step, ensuring accuracy and
                  consistency throughout your application process. Our team
                  keeps you informed and updated on your application status,
                  providing peace of mind during this important journey.
                </p>
            ...
            {cards.map((card, index) => (
              ...
              >
                ...
                <CardContent className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <p className="text-white text-xs px-3">{card.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
