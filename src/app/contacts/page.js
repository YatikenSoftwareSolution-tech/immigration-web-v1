                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex ">
                        <span className="text-dark text-sm font-semibold">Hours:</span>
                        <span className="text-dark text-sm ml-[40px]">
                          11:00 AM - 3:00 PM MDT
                        </span>
                      </div>
                      <div className="flex ">
                        <span className="text-dark text-sm font-semibold">Saturday:</span>
                        <span className="text-dark text-sm ml-[24px]">Closed</span>
                      </div>
                      <div className="flex">
                        <span className="text-dark text-sm font-semibold">Sunday:</span>
                        <span className="text-dark text-sm ml-[33px]">Closed</span>
                      </div>
                    </div>
                  </div>
                </div>
