        ...
        <div className="p-8 flex-1 text-dark">
          ...
          <div className="flex items-center ml-2 mb-6">
            ...
            <label htmlFor="terms" className="ml-2 text-gray-700 text-sm">
              I accept the{" "}
              <Link href={`/terms?name=${name}&email=${email}&mobile=${mobile}`} target="_blank" className="underline text-blue-600">
          ...
          <Link
            href={`https://calendar.app.google/9cjg5iYzzeHDD27d7?Link=https://immigrationCompany.ca/candidate/${recordId}`}
            target="_blank"
